...
export class AppService {
  ...
  static readonly businessArea: Array<BusinessArea> = [{"id":0,"name":"Любая"},
    {"id":2,"name":"Гостиничное и ресторанное дело"},{"id":4,"name":"Добыча полезных ископаемых"},
    {"id":20,"name":"Легкая промышленность"},	{"id":5,"name":"Лесное хозяйство"},{"id":9,"name":"Медицина"},
    {"id":6,"name":"Научная деятельность"},{"id":8,"name":"Недвижимость"},{"id":7,"name":"Образование"},
    {"id":10,"name":"Перерабатывающая промышленность"},{"id":14,"name":"Рыболовство"},{"id":15,"name":"Сельское хозяйство"},
    {"id":22,"name":"СМИ и реклама"},{"id":21,"name":"Спорт и туризм"},{"id":16,"name":"Строительство"},
    {"id":11,"name":"Сфера услуг"},{"id":19,"name":"Технологии и телекоммуникации"},{"id":17,"name":"Торговля"},
    {"id":3,"name":"Транспорт и связь"},	{"id":13,"name":"Тяжелая промышленность"},{"id":18,"name":"Финансовая деятельность"},
    {"id":12,"name":"Энергетика"}];
