...
export class AppService {
  ...
  static readonly businessArea: Array<BusinessArea> = [{id:0,"name":"Любая"},{"id":1,"name":"Деятельность домашних хозяйств"},{"id":2,"name":"Деятельность отелей и ресторанов"},{"id":3,"name":"Деятельность транспорта и связи"},{"id":4,"name":"Добыча полезных ископаемых"},{"id":5,"name":"Лесное хозяйство"},{"id":6,"name":"Научная деятельность"},{"id":7,"name":"Образование"},{"id":8,"name":"Операции с недвижимостью, арендные операции"},{"id":9,"name":"Охрана здоровья, медицина"},{"id":10,"name":"Перерабатывающая промышленность"},{"id":11,"name":"Предоставление услуг"},{"id":12,"name":"Производство и перераспределение электроэнергии"},{"id":13,"name":"Производство машин и оборудования"},{"id":14,"name":"Рыболовство и разведение рыбы"},{"id":15,"name":"Сельское хозяйство и охота"},{"id":16,"name":"Строительство"},{"id":19,"name":"Технологии и телекоммуникации"},{"id":17,"name":"Торговля"},{"id":18,"name":"Финансовая деятельность"}];
